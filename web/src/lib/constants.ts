...
export const STATEMENT_DATA: StatementCardProps[] = [
    {
    ...
    },
    {
        ...
        statement: 'First human teleported by 2040',
        status: 'proposed',
        bond: 5,
        dispute: {
            window: 60,
    ...
    },
    {
        ...
        statement: 'Global internet via satellites',
        status: 'resolved',
        bond: 40,
        dispute: {
            window: 12,
    ...
    },
    {
        ...
        statement: 'Ocean cleanup removes 90% of plastic',
        status: 'voting',
        bond: 30,
        dispute: {
            window: 18,
    ...
    },
    {
        ...
        statement: 'Fusion energy powers a city',
        status: 'proposed',
        bond: 80,
        dispute: {
            window: 25,
    ...
    },
    {
        ...
        statement: 'Self-driving cars dominate roads',
        status: 'voting',
        bond: 55,
        dispute: {
            window: 15,
